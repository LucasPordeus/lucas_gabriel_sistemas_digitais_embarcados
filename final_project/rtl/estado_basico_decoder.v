// estado_basico_decoder: decodificador combinacional preliminar.
// Mapeia um estado de 2 bits do semaforo de veiculos para os 3 LEDs
// (vermelho, amarelo, verde). Base para o decodificador completo do TP2.
